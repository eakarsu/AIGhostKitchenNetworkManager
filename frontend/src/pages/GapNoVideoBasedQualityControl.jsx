...
// Auto-generated page for: No video-based quality control

export default function GapNoVideoBasedQualityControl() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-video-based-quality-control', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No video-based quality control</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No video-based quality control</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No video-based quality control'}
        </button>
      </form>
