...
// Auto-generated page for: Workforce burnout prediction based on labor-hour patterns wi

export default function CfWorkforceBurnoutPredictionBasedOnLa() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-workforce-burnout-prediction-based-on-la', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Workforce burnout prediction based on labor-hour patterns wi</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Workforce burnout prediction based on labor-hour patterns with retention nudges.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Workforce burnout prediction based on labor-hour patterns wi'}
        </button>
      </form>
