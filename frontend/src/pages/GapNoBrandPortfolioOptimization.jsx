...
// Auto-generated page for: No brand-portfolio optimization

export default function GapNoBrandPortfolioOptimization() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-brand-portfolio-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No brand-portfolio optimization</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No brand-portfolio optimization</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No brand-portfolio optimization'}
        </button>
      </form>
