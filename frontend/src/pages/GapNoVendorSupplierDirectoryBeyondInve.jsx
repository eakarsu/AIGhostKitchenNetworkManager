...
// Auto-generated page for: No vendor / supplier directory beyond inventory

export default function GapNoVendorSupplierDirectoryBeyondInve() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-vendor-supplier-directory-beyond-inve', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No vendor / supplier directory beyond inventory</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No vendor / supplier directory beyond inventory</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No vendor / supplier directory beyond inventory'}
        </button>
      </form>
