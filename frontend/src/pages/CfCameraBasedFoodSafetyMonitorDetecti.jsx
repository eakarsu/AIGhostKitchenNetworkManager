...
// Auto-generated page for: Camera-based food safety monitor detecting handwashing, glov

export default function CfCameraBasedFoodSafetyMonitorDetecti() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-camera-based-food-safety-monitor-detecti', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Camera-based food safety monitor detecting handwashing, glov</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Camera-based food safety monitor detecting handwashing, glove use, temperature compliance.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Camera-based food safety monitor detecting handwashing, glov'}
        </button>
      </form>
