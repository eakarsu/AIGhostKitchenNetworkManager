...
// Auto-generated page for: No file upload module for menu photos

export default function GapNoFileUploadModuleForMenu() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-file-upload-module-for-menu', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No file upload module for menu photos</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No file upload module for menu photos</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No file upload module for menu photos'}
        </button>
      </form>
