...
// Auto-generated page for: Delivery zone heat map with surge pricing and underserved-ar

export default function CfDeliveryZoneHeatMapWithSurge() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-delivery-zone-heat-map-with-surge', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Delivery zone heat map with surge pricing and underserved-ar</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Delivery zone heat map with surge pricing and underserved-area expansion suggestions.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Delivery zone heat map with surge pricing and underserved-ar'}
        </button>
      </form>
