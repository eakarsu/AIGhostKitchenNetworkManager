...
// Auto-generated page for: Seasonal menu advisor tracking ingredient pricing and demand

export default function CfSeasonalMenuAdvisorTrackingIngredien() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-seasonal-menu-advisor-tracking-ingredien', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Seasonal menu advisor tracking ingredient pricing and demand</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Seasonal menu advisor tracking ingredient pricing and demand to recommend pivots 4-6 weeks ahead.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Seasonal menu advisor tracking ingredient pricing and demand'}
        </button>
      </form>
