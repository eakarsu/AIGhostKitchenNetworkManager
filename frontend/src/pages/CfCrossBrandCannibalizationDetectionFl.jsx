...
// Auto-generated page for: Cross-brand cannibalization detection flagging menu items th

export default function CfCrossBrandCannibalizationDetectionFl() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-cross-brand-cannibalization-detection-fl', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Cross-brand cannibalization detection flagging menu items th</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Cross-brand cannibalization detection flagging menu items that erode sister-brand sales.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Cross-brand cannibalization detection flagging menu items th'}
        </button>
      </form>
