...
// Auto-generated page for: No driver route optimization

export default function GapNoDriverRouteOptimization() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-driver-route-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No driver route optimization</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No driver route optimization</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No driver route optimization'}
        </button>
      </form>
