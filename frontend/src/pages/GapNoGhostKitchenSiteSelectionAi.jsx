...
// Auto-generated page for: No ghost-kitchen site-selection AI

export default function GapNoGhostKitchenSiteSelectionAi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-ghost-kitchen-site-selection-ai', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No ghost-kitchen site-selection AI</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No ghost-kitchen site-selection AI</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No ghost-kitchen site-selection AI'}
        </button>
      </form>
